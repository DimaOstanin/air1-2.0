...
export default function CreateListing() {
  ...
  return (
    <main className="p-3 max-w-4xl mx-auto ">
      <h1 className="text-3xl font-semibold text-center my-7">עדכון מוצר </h1>
      <form
        onSubmit={handleSubmit}
        className="flex flex-col justify-end sm:flex-row gap-4"
      >
        <div className="flex flex-col gap-4 flex-1">
          ...
          <div className="flex gap-6 flex-wrap">
            <div className="flex flex-row gap-2">
              ...
              <label className="direction-rtl text-right  flex items-center ">
                יש לבחור מצב
              </label>
            </div>
            <div className="flex flex-row direction-rtl gap-2 justify-end">
              <select
                className="border p-3 rounded-lg direction-rtl item-right "
                id="category"
                onChange={handleChange}
              >
        ...
        <div className="flex flex-col flex-1 gap-4">
          <div className="flex flex-row ">
            ...
            <p className="font-semibold">:תמונות</p>
          </div>
